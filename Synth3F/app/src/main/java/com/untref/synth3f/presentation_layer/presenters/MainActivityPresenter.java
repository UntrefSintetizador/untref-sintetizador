...
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.SequencerPopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.EGPopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.MIXPopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.ModulePopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.SHPopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.VCAPopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.VCFPopupWindow;
import com.untref.synth3f.presentation_layer.ModulesPopupWindow.VCOPopupWindow;
import com.untref.synth3f.presentation_layer.activity.MainActivity;
import com.untref.synth3f.domain_layer.helpers.MasterConfig;
...
public class MainActivityPresenter {
    ...
    private ModulePopupWindow createPopUpWindow(String name, String name_popUp){
        ...
        switch (name) {
            ...
            case "Sequencer": popupWindow = new SequencerPopupWindow(context, R.layout.popup_sequencer,name_popUp); break;
        }
    ...
    public void createPopUpSliders(){
        ...
        String[] SHSliders = {"SH"};
        String[] SequencerSliders = {"Sequencer"};
        ...
        sliders.put("Sequencer",SequencerSliders);
