...
public class PatchVCOPresenter extends PatchPresenter {
    ...
    public PatchVCOPresenter(PatchView patchView, PatchGraphPresenter patchGraphPresenter) {
    ...
    public PatchMenuView createMenuView(MainActivity context) {
        return new PatchVCOMenuView(context, R.layout.popup_vco, name + Integer.toString(patchView.getPatchId()), this);
    }
}
