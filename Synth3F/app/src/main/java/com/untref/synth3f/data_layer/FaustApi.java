...
public class FaustApi {
    ...
    public static native void addPatchFaustApi(long android_graph_adapter_pointer, String code,
                                               int id);

    public static native void removePatchFaustApi(long android_graph_adapter_pointer, int id);

    public static native void setValueFaustApi(long android_graph_adapter_pointer, String name,
                                               float value);

    public static native void connectFaustApi(long android_graph_adapter_pointer, int source,
                                              int outlet, int target, int inlet);

    public static native void disconnectFaustApi(long android_graph_adapter_pointer, int source,
                                                 int outlet, int target, int inlet);

    public static native void processFaustApi(long android_graph_adapter_pointer, float[] jdata,
                                              int channels);
