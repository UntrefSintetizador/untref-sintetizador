...
struct CircularBuffer
{
    ...
    short* getWritePtr()
    {
        return &fBuffer[fWriteIndex * fChan];
    }
    short* getReadPtr()
    {
        return &fBuffer[fReadIndex * fChan];
    }
...
audio* audio::InitAndroidAudio(long srate, long bsize){
    audio* result = new androidaudio(srate, bsize);
    return result;
}
